...
import com.hqbb.duanzi.adapter.BookMarkAdapter;
import com.hqbb.duanzi.adapter.TocListAdapter;
...
import com.hqbb.duanzi.bean.support.ReadTheme;
import com.hqbb.duanzi.component.AppComponent;
import com.hqbb.duanzi.component.DaggerBookComponent;
import com.hqbb.duanzi.contract.BookReadContract;
import com.hqbb.duanzi.easyadapter.ReadThemeAdapter;
...
import com.hqbb.duanzi.manager.ThemeManager;
import com.hqbb.duanzi.presenter.BookReadPresenter;
import com.hqbb.duanzi.service.DownloadBookService;
import com.hqbb.duanzi.util.AppUtils;
import com.hqbb.duanzi.util.FileUtils;
import com.hqbb.duanzi.util.FormatUtils;
import com.hqbb.duanzi.util.LogUtils;
import com.hqbb.duanzi.util.ScreenUtils;
import com.hqbb.duanzi.util.SharedPreferencesUtil;
import com.hqbb.duanzi.util.ToastUtils;
import com.hqbb.duanzi.widget.readview.BaseReadView;
import com.hqbb.duanzi.widget.readview.NoAimWidget;
import com.hqbb.duanzi.widget.readview.OnReadStateChangeListener;
import com.hqbb.duanzi.widget.readview.OverlappedWidget;
import com.hqbb.duanzi.widget.readview.PageWidget;
...
public class ReadActivity extends BaseBookActivity implements BookReadContract.View  {
...
//        ttsConfig = TTSPlayerUtils.getTtsConfig();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        switch (requestCode) {
            case 1:
                if (resultCode == RESULT_OK) {  //换源
                    BookSource bookSource = (BookSource) data.getSerializableExtra("source");
                    bookId = bookSource._id;
                    String link = bookSource.link;
                    String type = bookSource.name;
                    Intent intent = new Intent(ReadActivity.this, NewsDetailActivity.class);
