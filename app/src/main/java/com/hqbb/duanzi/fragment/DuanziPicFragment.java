...
public class DuanziPicFragment extends BaseFragment {
    ...
    public View initView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mView = inflater.inflate(R.layout.fragment_pic, container, false);
...
//                    return;
//                }
//                requestDataMore(AppApplication.PIC_TYPE, curPage);
...
//        });
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                requestData(AppApplication.PIC_TYPE, 0);
