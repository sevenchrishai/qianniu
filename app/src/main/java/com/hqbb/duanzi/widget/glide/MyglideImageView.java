package com.hqbb.duanzi.widget.glide;
...
//
      ...
      //  Drawable drawable2=zoomDrawable(drawable,30,30);
        Glide.with(context)
                .load(imgurl)
                .placeholder(CorpDrawableBuilder.build( ActivityCompat.getDrawable(context, R.mipmap.default_avator), Color.WHITE))
                .centerCrop()
                .into(ivImg);

    }

    public static void setImgAsBitmap(Context context, ImageView ivImg,String imgurl){
        Glide.with(context)
                .load(imgurl)
                .asBitmap()
                .placeholder(CorpDrawableBuilder.build( ActivityCompat.getDrawable(context, R.mipmap.default_avator), Color.WHITE))
    ...
    public static void setImgAsGif(Context context, ImageView ivImg, String imgurl, final ProgressBar progressBar){
        Glide.with(context)
                .load(imgurl)
                .asGif()
    ...
    public static void setImgfit(Context context, ImageView ivImg,String imgurl){
        Glide.with(context)
                .load(imgurl)
                .placeholder(CorpDrawableBuilder.build( ActivityCompat.getDrawable(context, R.mipmap.default_avator), Color.WHITE))
                .fitCenter()
    ...
    public static void setLocalRoundImg(Context context, ImageView ivImg,Integer localsrc){
        Glide.with(context)
                .load(localsrc)
                .bitmapTransform(new CropCircleTransformation(context) )
                .into(ivImg);
