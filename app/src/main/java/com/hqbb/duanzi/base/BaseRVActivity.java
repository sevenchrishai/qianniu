 ...
 * @date 16/9/3.
 */
public abstract class BaseRVActivity<T> extends BaseBookActivity implements OnLoadMoreListener, OnRefreshListener, RecyclerArrayAdapter.OnItemClickListener {
