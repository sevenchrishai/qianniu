...
import com.hqbb.duanzi.widget.recyclerview.OnRefreshListener;
import com.hqbb.duanzi.widget.recyclerview.adapter.OnLoadMoreListener;
 ...
 * @date 16/9/3.
 */
public abstract class BaseRVFragment<T1 extends BaseContract.BasePresenter, T2> extends BaseBookFragment implements OnLoadMoreListener, OnRefreshListener, RecyclerArrayAdapter.OnItemClickListener {
