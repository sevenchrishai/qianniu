...
public abstract class BaseBookActivity extends AppCompatActivity {
    ...
    private boolean mNowMode = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initDatas();
        configViews();
        mNowMode = SharedPreferencesUtil.getInstance().getBoolean(Constant.ISNIGHT, false);
    }
